...
.prefix = "zzz_test_lookback6mo_KGclean_"
.lookback_months = dmonths(6)
if(Sys.getenv("HOME")!="/Users/jdomi") setwd("/n/data1/hsph/biostat/celehs/lab/SHARE/PDDS_Imputation")
...
cohort <- read_csv(here("Data", "created_data", "pdds_cohort_6molookback_2023_11_21.csv")
...
if("keepcausal" %nin% tolower(bash_args)){
  ...
  .countdf = cohort %>% left_join(.remove_df, "PATIENT_NUM")
